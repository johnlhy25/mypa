	...
	<div class="modal-dialog modal-md" role="document">	
		<div class="modal-content">
			...
			<div class="modal-header">
				<h3 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus"></i> Add Quarter</h3>
			...
			<div class="modal-body text-center">
				<?= form_open('add_quarter'); ?>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="cat_desc" placeholder="1st Quarter" required>
                        </div>
                    </div>
