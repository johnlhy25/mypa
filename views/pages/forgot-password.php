          ...
          <div class="row">
            ...
            <div class="col-lg-6" style="background: #fffdf8;">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <div class="logo text-center">
                    <img class="img-fluid" src="<?= base_url();?>assets/img/Forgot.webp">
                  </div>
                    <br>
                    ...
                    <?php if($this->session->flashdata('success_data')) : ?>
                      <?= '<p class="alert alert-success">'.$this->session->flashdata('success_data').' <button type="button" class="close" data-dismiss="alert">&times;</button></p>'?>
                    <?php endif;?>

                      <?= form_open('forgot', 'class="form-validate"'); ?>
                      <div class="form-group">
                        <input id="login-username" type="email" name="signupemail" required data-msg="Please enter your email" class="input-material" value="<?= set_value('Username')?>">
                      ...
                      <div class="form-group">
                        <input class="btn btn-primary" type="submit" name="submit" id="submit" value="Reset Password">
                      </div>
                      
				              <small>Do not have an account? </small><a href="<?= base_url()?>register" class="signup">Sign up</a>
                        <br>
                      <small>Already have an account? </small><a href="<?= base_url();?>" class="signup">Sign in</a>
                </div>
              </div>
            </div>
