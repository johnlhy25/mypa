  ...
  <div class="container">
    <div class="advisory-box mt-3">
      ...
      <div class="advisory-text">
        <h2>Please be informed that the TDIS: Performance Monitoring Report / Pillar III System will be temporarily inaccessible due to the updating of the Office Performance Commitment and Review (OPCR).</h2>
      </div>
    </div>
  </div>
