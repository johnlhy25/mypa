<html>
<body onload="exportTableToExcel('tblExportTPMRF', 'TRAINING PROGRAM MONITORING REPORT FORM as of <?= date('m-d-Y')?>')">
<style type="text/css">
...
<center>
<table id="tblExportTPMRF" class="tg">
<thead>
  <tr>
    <th class="tg-baqh" colspan="5"><b>Technical Education and Skills Development Authority - Regional Office No. 02<br>TRAINING PROGRAM MONITORING REPORT FORM</b><br>For the month of <b><?= $parameter?></b><br>CY <?= $year?></th>
    <th class="tg-baqh" colspan="2"><br><b>TESDA-OP-AS-01-F06<br>Rev. No. 00 – 03/01/17</b></th>
  </tr>
</thead>
<tbody>
  <tr>
