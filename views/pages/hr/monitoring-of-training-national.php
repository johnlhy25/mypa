		...
		<div class="col-lg-12 mt-3">
			<div class="card">
				...
				<div class="card-header d-flex align-items-center">
					<h1> Monitoring of National Training Program Invitations (FY <?= $year?>)</h1>
				</div>
					<div class="card-body">
						...
						<div class="table-responsive mt-2">   
										...
										<table id="listofinv" class="table table-striped table-hover">
											...
											<tbody>
												...
												<?php
													$numrow = 0;
													foreach($list_of_trainings_inv_national as $row){
													$numrow = $numrow+1;
			...
			<script type="text/javascript">
				const change_url1 = () => {
					...
					$("a.filter").attr('href', "<?= base_url()?>list_of_training_inv_national/" + yearx);
					};
			</script>
