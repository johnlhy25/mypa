<html>
	<head>
		...
		<link rel="shortcut icon" href="<?= config_item('base_url');?>/assets/img/Logo.png">
...
* {
	...
	<body>
	    ...
	    <div class="page-wrapper">
			<img src="<?= config_item('base_url');?>/assets/img/Logo.png" class="logos" alt="MYPA Logo" height="250px" width="290px">
	        ...
	        <div class="numbers-layer">
	            ...
	            <div class="number">N</div>
	            <div class="number">A</div>
	            <div class="number -with-shadow">N</div>
	            <div class="number -with-shadow">C</div>
	            <div class="number -with-shadow">E</div>
	        </div>
	        <div class="oops-message">
	            <div class="test"><h4>This website is under maintenance</strong></h2></div>
	            <div>
