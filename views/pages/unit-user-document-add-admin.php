	...
	<div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom"><?= $ous_desc; ?>: <?= $unit?></h2>
            </div>
          </header>
					...
					<div class="dropdown">
						<button type="button" id="closeCard3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-ellipsis-v"></i></button>
								<div aria-labelledby="closeCard3" class="dropdown-menu dropdown-menu-right has-shadow">
									...
									<a  href="<?= base_url()?>zip_download_per_quarter/<?= $back_link; ?>" class="dropdown-item edit"> <i class="fa fa-download"></i>Download All Documents</a>
								</div>
					</div>
				</div>
											...
											<!-- Modal Delete -->
												...
												<div class="modal-dialog" role="document">
													...
													<div class="modal-body text-center">
														<?= form_open('delete_exhibits_docs1'); ?>
												...
												<div class="modal fade delete" id="edit<?= $row['file_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
														<div class="modal-dialog modal-lg" role="document">	
															<div class="modal-content">
																...
																<div class="modal-body text-center">
																	<?= form_open_multipart('edit_exhibits_docs1'); ?>
																	<input type="hidden" name="file_filename" value="<?= $row['file_filename'] ?>">
																	<input type="hidden" name="file_id" value="<?= $row['file_id'] ?>">
																	...
																	<div class="row form-group">
																		<div class="col-sm-3">
																			<label class="control-label pull-left" style="position:relative; top:7px;"><i class="fa fa-external-link-square"></i> Google Link:</label>
																		</div>
																		<div class="col-sm-9">
